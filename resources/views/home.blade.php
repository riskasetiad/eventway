                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center my-1">
                                                <div
                                                    class="avatar-sm rounded me-3 align-items-center justify-content-center d-flex">
                                                    <img src="{{ asset('assets/images/users/user-14.jpg') }}"
                                                        class="img-fluid rounded-circle" alt="">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td class="border-0">
                                            <div class="d-flex align-items-center my-1">
                                                <div
                                                    class="avatar-sm rounded me-3 align-items-center justify-content-center d-flex">
                                                    <img src="{{ asset('assets/images/users/user-15.jpg') }}"
                                                        class="img-fluid rounded-circle" alt="">
                                                </div>
                                                <div>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="p-1 me-3 align-items-center justify-content-center d-flex">
                                                    <img src="{{ asset('assets/images/products/dresses.jpg') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="p-1 me-3 align-items-center justify-content-center d-flex">
                                                    <img src="{{ asset('assets/images/products/bags.jpg') }}"
                                                        class="img-fluid rounded" alt="product image" width="40px">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="p-1 me-3 align-items-center justify-content-center d-flex">
                                                    <img src="{{ asset('assets/images/products/shoes.jpg') }}"
                                                        class="img-fluid rounded" alt="product image" width="40px">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="p-1 me-3 align-items-center justify-content-center d-flex">
                                                    <img src="{{ asset('assets/images/products/headphone.jpg') }}"
                                                        class="img-fluid rounded" alt="product image" width="40px">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td class="border-0">
                                            <div class="d-flex align-items-center">
                                                <div class="p-1 me-3 align-items-center justify-content-center d-flex">
                                                    <img src="{{ asset('assets/images/products/camera.jpg') }}"
                                                        class="img-fluid rounded" alt="product image" width="40px">
                                                </div>
                                                <div>
